...
public class mergeSort{
	...
	public static void generateLog(int comparacoes, int movimentacoes, long tempoNano){
	    try{
	        FileWriter fw = new FileWriter("903104_merge.txt");
	...
	public void sort(ColecaoRestaurantes colecao){
		if(colecao.getTamanho() > 0){
			mergeSort(colecao.getRestaurantes(), 0, colecao.getTamanho() - 1);
		}
	}
	//dividindo os subvetores e chamando recursivamente para ordenar. Apos as chamadas, ocorre a intercalacao
	private void mergeSort(Restaurante[] r, int esq, int dir){
		if(esq<dir){
			int meio = (esq+dir)/2;
			mergeSort(r, esq, meio);
			mergeSort(r, meio+1, dir);
			intercalar(r, esq, meio, dir);
		}
	}
	
	private void intercalar(Restaurante[] r, int esq, int meio, int dir){
		int r1 = meio - esq + 1;
		int r2 = dir - meio;

		Restaurante[] a1 = new Restaurante[r1];
		Restaurante[] a2 = new Restaurante[r2];
	...
	public static void main(String[] args){
		...
		generateLog(ms.comparacoes, ms.movimentacoes, tempo);
