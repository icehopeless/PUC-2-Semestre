...
public class pesquisaSequencial{	
	...
	public static void generateLog(int comparacoes,long tempoNano){
	    try{
	        FileWriter fw = new FileWriter("903104_sequencial.txt");
	        double tempoSegundos = tempoNano / 1_000_000_000.0;
		
	        fw.write("903104\t" + comparacoes + "\t" + tempoSegundos);
	        fw.close();
	...
	public boolean pesquisa(ColecaoRestaurantes colecao, String chave){
		Restaurante []res = colecao.getRestaurantes();
		for(int i = 0; i < colecao.getTamanho(); i++){
			this.comparacoes++;
			if(chave.compareTo(res[i].getNome()) == 0){
				 return true;
	...
	public static void main(String[] args){
		...
		pesquisaSequencial ps = new pesquisaSequencial();
		...
		generateLog(ps.comparacoes, tempo);
